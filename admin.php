...
<head>
    ...
    <title>Data Mahasiswa Annur</title>
...
<body class="bg-light">
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    <li class="nav-item">
                        <a class="nav-link active text-sm-start text-center" aria-current="page" href="index.html">Home</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-5">
            ...
            <!-- tambah data -->
            <div class="card-body">
                <h3 class="card-title">Tambah Data Mahasiswa Ilmu Komputer</h3>
                <p class="card-text">TUGAS WEBSITE CRUD (CREATE, READ, UPDATE, DELETE)</p>
            ...
            <div class='modal-dialog' style="margin-bottom:100px !important;">
                <div class='modal-content'>
                    <div class='modal-header'>
                        <h5 class='modal-title' id='exampleModalLabel'>Edit Data Mahasiswa Annur</h5>
                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="edit_NIM" id="edit_NIM" class="form-control" placeholder="2300000" required>
                            </div>
